...
<div class="flex items-center justify-between mb-4">
    <div>
        ...
        <p class="text-sm text-slate-500">Kelola akun PPPoE di FreeRADIUS.</p>
    </div>
    <a href="{{ route('pppoe.create') }}" class="px-4 py-2 bg-[#0f4d8a] text-white rounded-lg text-sm">+ Buat User</a>
</div>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full text-sm">
            ...
            <tbody>
                ...
                @empty
                    <tr><td colspan="3" class="px-4 py-8 text-center text-slate-400">Belum ada data — pastikan koneksi RADIUS terkonfigurasi di .env.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
